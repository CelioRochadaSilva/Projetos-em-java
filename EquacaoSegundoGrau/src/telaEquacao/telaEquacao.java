...
public class telaEquacao extends javax.swing.JFrame {
    ...
    public telaEquacao() {
        initComponents();
        panResultado.setVisible(false); // vai evitar inicialmnte que o painel não seja mostrado
    }
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Calculadora Equação 2 grau");
        ...
        jLabel4.setText("Tipos de raizes");
        ...
        panResultadoLayout.setHorizontalGroup(
            ...
            .addGroup(panResultadoLayout.createSequentialGroup()
                ...
                .addGroup(panResultadoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblDelta, javax.swing.GroupLayout.DEFAULT_SIZE, 207, Short.MAX_VALUE)
    ...
    private void btnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcActionPerformed
        // TODO add your handling code here:
        int a = Integer.parseInt(txtA.getValue().toString()); // pegando os valor
        int b = Integer.parseInt(txtB.getValue().toString());
        int c = Integer.parseInt(txtC.getValue().toString());
        double d = Math.pow(b, 2) -4 * a * c; // calculo do delta
        lblDelta.setText(String.format("%.1f", d));
        
        if(d < 0){
            lblRaiz.setText("Não eixste raizes reais");
        }else{
            lblRaiz.setText("Existe raiz reais");
        }
                
        panResultado.setVisible(true);// ao clicar no bota exibira o painel
